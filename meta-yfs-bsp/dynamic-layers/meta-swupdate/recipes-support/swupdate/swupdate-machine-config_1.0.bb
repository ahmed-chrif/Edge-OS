...
SRC_URI = "\
    ...
    file://swupdate-tmpfiles.conf \
    file://swupdate-machine-config.service \
"
...
FILES:${PN} += "\
    ...
    ${libexecdir}/swupdate \
    ${systemd_system_unitdir}/swupdate-machine-config.service \
"

SYSTEMD_SERVICE:${PN} = "swupdate-machine-config.service"
